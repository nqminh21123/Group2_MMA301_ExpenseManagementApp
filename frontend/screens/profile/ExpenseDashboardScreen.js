    ...
    <ScrollView style={styles.container}>
      <Card style={styles.headerCard}>
        ...
        <View style={styles.viewSelector}>
          <TouchableOpacity
            style={[styles.viewButton, selectedView === 'month' && styles.activeViewButton]}
            onPress={() => handleChangeView('month')}
          >
            <Text style={[styles.viewButtonText, selectedView === 'month' && styles.activeViewButtonText]}>Tháng</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={[styles.viewButton, selectedView === 'year' && styles.activeViewButton]}
            onPress={() => handleChangeView('year')}
          >
            <Text style={[styles.viewButtonText, selectedView === 'year' && styles.activeViewButtonText]}>Năm</Text>
          </TouchableOpacity>
        </View>
        ...
        return (
          <View key={index} style={styles.barItem}>
            <View style={styles.barLabelContainer}>
              ...
              <Text style={styles.barAmount}>{item.amount.toLocaleString()} đ</Text>
            </View>
            ...
            {categoryData.map((category, index) => {
              ...
              return (
                <View key={index} style={styles.categoryItem}>
                  ...
                  <Text style={styles.categoryAmount}>{category.amount.toLocaleString()} đ</Text>
                </View>
              );
            })}
          </View>
